...
Detailed measurements, the experiment harness, and rejected tuning branches. Moved out of the README; the narrative for each stage (U0–U12) is in [RESEARCH_LOG.md](../RESEARCH_LOG.md) and [UPSTREAM_PLAN.md](../UPSTREAM_PLAN.md).
