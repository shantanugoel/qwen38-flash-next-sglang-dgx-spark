# Verbatim copy of python/sglang/srt/layers/attention/qsa/sm121_varlen.py from
# sgl-project/sglang#36845 (BBuf, 2026-08-28, base branch qwen4-main-squashed).
# serve.sh mounts it at <sglang>/srt/layers/attention/qsa/sm121_varlen.py.
