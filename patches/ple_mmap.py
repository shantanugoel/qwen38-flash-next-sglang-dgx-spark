...
Swaps torch.empty(..., pin_memory=True) in Qwen4ExpPinnedHostEmbedding for a
file-backed torch.from_file. On GB10 the gather kernel dereferences that host
pointer, so the 48 GiB table never has to be resident, and CUDA graphs still
capture.
